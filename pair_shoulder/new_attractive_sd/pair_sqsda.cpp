...
PairSqsda::PairSqsda(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  writedata = 1;
  single_enable = 1;
...
// void PairSqsda::compute(int eflag, int vflag)
// {
...
void PairSqsda::settings(int narg, char **arg)
{
...
void PairSqsda::coeff(int narg, char **arg)
{
...
// double PairSqsda::init_one(int i, int j)
// {
//   if (setflag[i][j] == 0) {
...
void PairSqsda::write_restart(FILE *fp)
{
...
void PairSqsda::write_restart_settings(FILE *fp)
{
...
void PairSqsda::read_restart(FILE *fp)
{
...
void PairSqsda::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairSqsda::write_data(FILE *fp)
{
...
void PairSqsda::write_data_all(FILE *fp)
{
...
double PairSqsda::single(int i, int j, int itype, int jtype, double rsq, double factor_coul,
...
void *PairSqsda::extract(const char *str, int &dim)
{
  dim = 2;
